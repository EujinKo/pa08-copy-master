    ...
    public boolean onTouchEvent(MotionEvent event){
        ...
        switch(event.getAction()){
            case MotionEvent.ACTION_DOWN:
                ...
                pathRef.setValue(touchX+"%%%"+touchY+"%%%"+paintSize+"%%%"+paintColor+"%%%MOVE%%%TRUE");
                break;
            case MotionEvent.ACTION_MOVE:
                drawPath.lineTo(touchX,touchY);
                pathRef.setValue(touchX+"%%%"+touchY+"%%%"+paintSize+"%%%"+paintColor+"%%%LINE%%%TRUE");
                break;
            case MotionEvent.ACTION_UP:
                drawPath.lineTo(touchX,touchY);
//                TODO:drawpaint(paintcolor)
//                pathRef.push().child("paths").setValue(touchX+"$$$"+touchY+"$$$"+drawPaint+"$$$"+drawPath+"$$$"+paintSize+"$$$"+paintColor);
                pathRef.setValue(touchX+"%%%"+touchY+"%%%"+paintSize+"%%%"+paintColor+"%%%LINE%%%FALSE");
